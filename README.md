...
- 어문 규범: [ko_norm_2022.json](ko_norm_2022.json)
- 영어 번역 투: [en_ko_style_correction.json](en_ko_style_correction.json)
- 일어 번역 투: [ja_ko_style_correction.json](ja_ko_style_correction.json)
