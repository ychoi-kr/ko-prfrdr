...
KW_NAOf = "생각|보간|[가수증]감|동결|곱|[가제]공|[건입출]국|공격|[연체]결|[구변]경|[총포]괄|집권|[접출]근|송금|지급|가늠|기능|[차판]단|[도전]달|[담배해]당|[가기이작]동|[납취획]득|누락|[노]력|[관마수제훈]련|[기수]록|소멸|[발변설소연작제조증]명|[괄주지]목|함몰|질문|고민|위반|[개선]발|체벌|식별|[반중]복|구분|준비|계산|[손연향]상|발생|[분해]석|개선|[건개배연증해]설|[구생작완형]성|[계상접]속|[방소]송|[기저]술|[연학]습|[송수]신|송수신|임신|[장파]악|[고보제]안|[계예해]약|선언|[수성영작]업|[구시재]연|오염|[반운촬투]영|[사이작적통포활]용|훈육|[기지]원|불응|방일|통일|[기도수투]입|[수]?출입|[동시조]작|[긴등성저출]장|경쟁|산적|[발운회]전|조절|[걱검결설수지추측한]정|참조|방중|검증|감지|부진|선언|[개선수확]정|[도장부집탈]착|칭찬|제창|구축|[도산수연인제진창추]출|[계예]측|[강이]탈|[간선채]택|[면유입재]학|국한|방한|분할|포함|[결부취]합|[동발비서시수운연진]행|[재]?실행|[구실재표]현|[반변]환|계획"
KW_NAOh = '|'.join(conjugate("강|미|융|특", '화') + conjugate(ks.KS_Az, '화') + conjugate(KW_NTB, '화'))
KW_NAOv = "[인증추참평]가|[제탈]거|[공소전]개|[경방]과|[복연촉]구|[경대상연제표]기|이야기|[시유]도|[고]려|신뢰|[완치]료|[관격분수]리|[전후]?처리|마무리|연마|구매|소모|근무|방미|[공거기]부|[감공반발수식조퇴]사|[감기축]소|[감준회]수|[실제출표]시|제어|[기참]여|[긴소중필]요|[논유정주합회]의|[재]?정의|복제|[유주차폐]지|[기탑]재|대체|[갈성수탈편]취|[납배설]치|검토|돌파|[부실]패|배포|발표|[저전통]화|[분이]해|" + KW_NAOh 
