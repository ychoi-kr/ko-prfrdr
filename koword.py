...
KW_NTAv = "근거|[용정]도|메서드|스레드|코드|사용료|시류|메모리|처리|라이브러리|카테고리|리뷰|의사|[요축]소|[난변소인함]수|[극]?소수|부동소수점수|분위수|순서|마이크로서비스|서비스|클래스|[단언]어|레이어|소프트웨어|하드웨어|범위|차이|글자|일자|범주|이미지|[시절]차|아키텍처|피처|[고기물신액옥자형]체|가중치|관측치|배치|네트워크|에포크|태스크|데이터|벡터|학습 데이터|형태|세그먼트|이벤트|컴포넌트|크레이트|폰트|전자파|[분세점]포|좌표|번호|비밀번호|변화|기회"
...
KW_NTBv = "체계|카탈로그|[동초]기|[극최]대|고도|의무|[극최]소|독립변수|변수|특수|인스턴스|가시|해시|구조|민주|내재|수치|도커|[암복]호"
...
KW_NAOf1 = "곱"
KW_NAOf2 = "생각|보간|[가수증]감|동결|[가제]공|[건입출]국|공격|[연체]결|[구변]경|[총포]괄|집권|[접출]근|송금|지급|가늠|기능|[차판]단|[도전]달|[담배해]당|[가기운이작]동|[납취획]득|누락|[생중후]략|[노]력|[관마수제훈]련|[기수]록|소멸|[발변설소연작제조증]명|[괄주지]목|함몰|질문|고민|위반|[개선재폭]발|체벌|식별|[반중]복|구분|계산|[손연향]상|[검수탐]색|발생|[분해]석|개선|[건개배연증해]설|[구생작완형]성|[계상접]속|[방소전]송|[기저]술|[연학]습|[발송수통]신|임신|[장파]악|[고보제]안|[계예해]약|선언|[수성영작]업|[구시재]연|오염|[반운촬투]영|[사응이작적통포허활]용|훈육|[기지]원|[대불]응|방일|통일|[기도수출투]입|[동시조]작|[긴등성저출]장|경쟁|산적|[도발운회]전|조절|근접|[가개걱검결선설수조지추측한확]정|[마방]중|검증|감지|부진|[결매모수편]집|[도장부집탈]착|칭찬|제창|신청|[구압]축|[도산수연인제진창추]출|[계예]측|[강이]탈|[간선채]택|[면유입재]학|국한|방한|분할|포함|[결부취]합|[동발비서시수운연진]행|실행|시험|[구실재표]현|[반변]환|[계구기노]획"
