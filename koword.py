...
KW_NTAv = "선전 포고|근거|결과|[용정]도|가이드|메서드|스레드|코드|사용료|미래|[자재]료|시류|메모리|라이브러리|카테고리|리뷰|경영비|의사|[요축]소|[난변소인홍함]수|[극]?소수|부동소수점수|분위수|[순질]서|마이크로서비스|서비스|시퀀스|클래스|[단언]어|레이어|소프트웨어|하드웨어|수요|범위|차이|글자|일자|이미지|[시절]차|아키텍처|피처|[객물신옥형]체|가중치|관측치|배치|네트워크|에포크|태스크|데이터|벡터|학습 데이터|[상형]태|세그먼트|이벤트|컴포넌트|크레이트|폰트|전자파|[분세점]포|[목좌]표|면허|번호|비밀번호|변화|기회"
...
KW_NTJv = "단계|영구|대내|현대|진보|보수|도시|임시|[도원임한]시|대외|행위|독자|[민자]주|[실자총]체|향토"
...
#### Intransive
KW_NAOIf1 = "벌|찡|참"
KW_NAOIf2 = "일관|[입출]국|집권|[접출]근|기능|도달|탈락|[운]동|[중후]략|[노]력|[관]련|수렴|소멸|연명|[괄]목|함몰|[재폭]발|체벌|중복|손상|발생|연설|소송|통신|[긴등성출퇴]장|경쟁|산적|[도발회]전|근접|방중|[부승약]진|[면유입재]학|방한|[동비서유]행"
