...
KW_NAOf = "생각|보간|[가수증]감|곱|[가제]공|[건입출]국|공격|[연체]결|변경|[총포]괄|집권|[접출]근|송금|지급|가늠|기능|도달|[담배]당|[가기이작]동|[납취획]득|누락|[노]력|[관마수제훈]련|[기수]록|[발변설연작제조증]명|[괄지]목|함몰|질문|고민|[개선]발|체벌|[반중]복|구분|준비|계산|[손연향]상|발생|[분해]석|개선|[건개배연증해]설|[구생작완형]성|[계상접]속|[방소]송|[기저]술|[연학]습|임신|[장파]악|[고제]안|[예해]약|선언|[수성영작]업|[구시재]연|오염|[반운촬투]영|[사이작적통포활]용|훈육|[기지]원|불응|통일|[기도수투]입|[수]?출입|[동시조]작|[긴등성저출]장|경쟁|산적|[발운회]전|조절|[걱검결설수지추측한]정|참조|검증|감지|부진|선언|[개선수확]정|[도장부집탈]착|칭찬|제창|구축|[도산수연인제진창추]출|[계예]측|강탈|[간선채]택|[면유입재]학|국한|분할|포함|[결부취]합|[동비서시수운연진]행|[재]?실행|[구실재표]현|[반변]환|계획"
...
KW_NAOv = "[인증추참평]가|[제탈]거|[공소전]개|[경방]과|[복연촉]구|[경대상연제표]기|이야기|[시유]도|[고]려|[완치]료|[관격분수]리|[전후]?처리|마무리|연마|구매|소모|근무|[공거기]부|[감공반발수식조퇴]사|[감기축]소|[감준회]수|[실제출]시|제어|[기참]여|[긴소중필]요|[논유정주합회]의|[재]?정의|복제|[유주차폐]지|기재|대체|[성]취|[납배설]치|검토|돌파|[부실]패|배포|발표|[저전통]화|[분이]해|" + KW_NAOh 
...
### maChine(tool)
KW_NTCf = "로봇|툴"
KW_NTCv = "API|CPU|GPU|기계|비행기|생성기|판별기|항공기|웹[ ]?브라우저|로더|서버|장비|스토리지|차|기차|자동차|컴퓨터|클라이언트"
...
KW_NTHv = "개코|감태|그|하나|생때|신청부|생파리|납덩이|옴포동이|저|뚱딴지|불티|비호|성화"
