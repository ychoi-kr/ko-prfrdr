...
KC_D = "[되된돼됐]"
KC_H = "하고[는자]?|하겠\\w+|하[는니다며여]|하도록|하려[고는]?|하[?]면|하였\\w+|하지[만]?|한 [것뒤적후]|한 다음|한다[고는니며지]?|할|할까[요]?|할래|할지[도]?[요]?|함[을]?|함이다|함입니다|합니다|해보[니다면]|해볼[까래]?|해[서요]?|했고[요]?|했는데[요]?|했다[만]?|했습니다[만]?|했으[니면][서]?|했을[지]?|했지[만]?[요]?"
...
KW_NAOf = "생각|[가수증]감|가공|곱|[건입출]국|공격|[연체]결|방과|[총포]괄|집권|접근|가늠|[담배]당|[가이]동|[노]력|[관마수제훈]련|[기수]록|[발변설연작제조증]명|괄목|함몰|질문|고민|[개선]발|체벌|[반중]복|준비|[수조]사|[손연향]상|개선|발생|[건개배연증해]설|[구생작완형]성|[계상]속|[연학]습|임신|[장파]악|[예해]약|[수성영작]업|[구시재]연|오염|[반운촬투]영|[사이작적통포활]용|훈육|[지]원|불응|[승확]인|[도수투]입|[수]?출입|시작|[긴등성저출]장|[발운회]전|조절|[결설수지측한]정|검증|부진|선언|[개선수]정|[도장부집탈]착|칭찬|제창|[도수연인진창추]출|[계예]측|[간선채]택|[면유입재]학|국한|분할|포함|[결부취]합|[미전통]화|[구실재표]현|[비서진]행|[재]?실행|[동수연진]행"
KW_NAOh = "가시화|간소화|강화|경량화|공산화|도커화|모듈화|민주화|소형화|수치화|세분화|시각화|융화|인스턴스화|중앙화|첨예화|초기화|최[신적]화|캡슐화|파편화|패턴화|특[수]?화|현[실행]화|[0-9]+차원화|형상화"
KW_NAOv = "[인증추참평]가|[제탈]거|[공소]개|[연촉]구|[대상연제]기|이야기|시도|[고]려|[완치]료|[관격수처]리|마무리|연마|소모|근무|[공기]부|[감반발조]사|[감기축]소|[감준회]수|제시|제어|[기참]여|[긴소중필]요|[논유합회]의|[주차폐]지|대체|[성]취|[납배설]치|검토|배포|저하|이해|" + KW_NAOh 
KW_NAO = joinseq(KW_NAOf, KW_NAOv)

## can be Both of active(-하다) and passive(-받다)
KW_NABf = "비난|감동|처단|할당|[입출]력|주목|처방|[처]?벌|축복|전송|교육|구원|위임|대입|연장|판정|강종|추천|부탁|심판|반환|시험"
KW_NABv = "용서|강요|기부|보조|오해"
...
KW_NPJf = "감독[관]?[님]?|강사님|과장[님]?|교수님|[국군도동시]민|기업인|대[리표]님|대통령[님]?|[사의]원|[사소의회]장[님]?|시인|작[곡사]?가님|직장인|학생|[수해]병|초대 회장|회사원"
