...
KW_NAOTv1 = "요"
KW_NAOTv2 = "[인추평]가|[공소전]개|[제탈]거|설계|[복연촉]구|[대분상연제표]기|안내|[임증초확]대|[시유주]도|계류|[고]려|신뢰|[완종치]료|[관격분수처]리|연마|구매|소모|근무|[공거기발]부|준비|[감반발수조]사|[기축]소|[감준회]수|[감실제출표]시|제어|[기부참]여|[제]외|[소]요|[논유정주회]의|투자|복제|참조|[감유의차폐]지|[기탑]재|대체|[갈성수탈편]취|[납배설위]치|검토|돌파|배포|발표|보호|[분이화]해"
