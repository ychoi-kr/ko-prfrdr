...
KW_NAOf = "생각|[가증]감|가공|곱|[건입]국|[연체]결|[총포]괄|접근|가늠|[담배]당|가동|[노]력|[수제훈]련|[기수]록|[발변설연작제조증]명|괄목|함몰|고민|[개선]발|체벌|[반중]복|[손연향]상|개선|발생|[개배연증해]설|[구생작완형]성|[연학]습|[예해]약|오염|[반운투]영|[사이적통포활]용|훈육|[지]원|[도수]입|[수]?출입|시작|[긴등성]장|[발회]전|조절|[결설수지측한]정|선언|선정|[도장부탈]착|제창|[도수연인창추]출|예측|[간선채]택|[면입]학|국한|분할|포함|[결취]합|[구실재표]현|[동수실연진]행"
