...
KW_NAOv2 = "[인증추참평]가|[제탈]거|[공소전]개|설계|[경방]과|붕괴|[복연촉]구|[경대상연제표]기|[연증확]대|[시유]도|계류|[고]려|신뢰|[완치]료|[관격분수]리|처리|연마|구매|소모|근무|방미|[공거기]부|준비|[감공반발수식조퇴]사|[감기축]소|[감준회]수|[감실제출표]시|제어|[기부참]여|[소제]외|[긴소중필]요|[논유정주합회]의|정의|투자|복제|참조|[유주차폐]지|[기탑]재|대체|[갈성수탈편]취|[납배설위]치|검토|돌파|[부실]패|배포|발표|보호|[저전통]화|[분이]해"
