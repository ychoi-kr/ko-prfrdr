...
KW_NAOv = "[인증추참평]가|[제탈]거|[공소전]개|[경방]과|[복연촉]구|[경대상연제]기|이야기|[시유]도|[고]려|[완치]료|[관격분수]리|[전후]?처리|마무리|연마|구매|소모|근무|[공거기]부|[감공반발수식조퇴]사|[감기축]소|[감준회]수|[실제출]시|제어|[기참]여|[긴소중필]요|[논유정주합회]의|[재]?정의|복제|[유주차폐]지|대체|[성]취|[납배설]치|검토|돌파|[부실]패|배포|발표|[저전통]화|[분이]해|" + KW_NAOh 
