...
KW_NAOf = "생각|[가수증]감|가공|곱|[건입]국|[연체]결|[총포]괄|접근|가늠|[담배]당|가동|[노]력|[수제훈]련|[기수]록|[발변설연작제조증]명|괄목|함몰|고민|[개선]발|체벌|[반중]복|[손연향]상|개선|발생|[건개배연증해]설|[구생작완형]성|[연학]습|[예해]약|오염|[반운투]영|[사이적통포활]용|훈육|[지]원|[도수]입|[수]?출입|시작|[긴등성저]장|[발회]전|조절|[결설수지측한]정|검증|선언|[개선수]정|[도장부탈]착|칭찬|제창|[도수연인창추]출|예측|[간선채]택|[면입]학|국한|분할|포함|[결취]합|[구실재표]현|[비서진]행|[재]?실행|[동수연진]행"
KW_NAOh = "가시화|간소화|강화|경량화|공산화|도커화|민주화|소형화|수치화|세분화|시각화|융화|인스턴스화|첨예화|초기화|최[신적]화|캡슐화|파편화|패턴화|특[수]?화|현[실행]화|[0-9]+차원화"
KW_NAOv = "[인증추참평]가|[제탈]거|[공소]개|[연촉]구|[대상연제]기|이야기|시도|[고]려|[완치]료|[관격수처]리|마무리|연마|소모|근무|[공기]부|[감반발조]사|[감기축]소|[감준회]수|제시|[기참]여|[긴소중필]요|[논유합]의|[주차폐]지|대체|[성]취|[납배설]치|검토|저하|이해|" + KW_NAOh 
...
## Thing
### Abstract
KW_NTAf = "명산|모델|모형|모듈|방법|스텝|입력|전략|점|차원|채널|출력|층|토큰|토픽|튜플|특성|프로그램|함수|행렬"
