...
KW_NSv = "무의미|유사|[자섬]세|간소|[거장중]대|[중필]요|분포"
...
## Thing(무정물)
### Abstract
KW_NTAfc = "관측값|물건|자금|학년|게놈|성능|돈|[능출]력|연령|프로그램|걸음|목적|전략|칼럼|입력|기록|블록|그룹|스트림|화면|별명|[품항]목|논문|방법|재산|명산|형상|인생|성|창의성|[속특]성|데이터셋|솔루션|커넥션|애플리케이션|웹 애플리케이션|[r공방상지형]식|방안|직업|앱|영역|[내비]용|차원|웹|마음|도메인|디자인|요인|타입|점|규정|[단시장지]점|수준|알고리즘|인터넷|군집|대책|층|명칭|토큰|스택|스텝|시스템|패턴|팀|상품|토픽|국민[ ]?평형|모형|힙"
...
KW_NTAv = "선전 포고|근거|결과|[용정]도|가이드|메서드|스레드|코드|사용료|미래|[자재]료|시류|메모리|라이브러리|카테고리|리뷰|경영비|의사|[요축]소|[난변소인홍함]수|[극]?소수|부동소수점수|분위수|[순질]서|마이크로서비스|서비스|시퀀스|클래스|[단언]어|레이어|소프트웨어|하드웨어|수요|범위|차이|글자|일자|이미지|[시절]차|아키텍처|피처|[객물신옥자형]체|가중치|관측치|배치|네트워크|에포크|태스크|데이터|벡터|학습 데이터|[상형]태|세그먼트|이벤트|컴포넌트|크레이트|폰트|전자파|[분세점]포|[목좌]표|면허|번호|비밀번호|변화|기회"
...
KW_NTCf = "Babel|NPM|레즈넷|레티나넷|로봇|모바일넷|툴|논리 풀"
...
#### Transive
KW_NAOTf1 = "곱"
KW_NAOTf2 = "수감|[생착]각|보간|[가증]감|점검|공격|[가동연체]결|[구변]경|[가제]공|[건]국|[총포]괄|송금|[공지취]급|가늠|[차판]단|[배전]달|[담배해]당|[가기이작]동|[납취획]득|누락|사랑|[생]략|[입출]력|[마수제훈]련|[기수]록|[발변설소작제조증]명|[주지]목|[주질]문|고민|위반|[개선]발|식별|[반]복|구분|계산|[상연향]상|[검수탐]색|[재]생|[분해]석|개선|[건개배증해]설|[구생작완형]성|[계상접]속|[방배전]송|[기저]술|[연학]습|[발송수]신|임신|[장파]악|[고보제]안|[계예해]약|선언|[수성영작]업|검역|[구시재지]연|[나배사]열|오열|오염|[반운촬투]영|[사응이작적통포허활]용|[교훈]육|[기지]원|[대불]응|[방유]일|통일|[기도수출투]입|[동시조짐]작|[저]장|[운]전|이전|조절|[가개걱검결선설수조지추측한확]정|[마]중|검증|증진|[결매모수편]집|[도장부집탈]착|칭찬|제창|신청|[구압]축|[검누도산수연인제진창추호]출|[계예]측|[강이]탈|[간선채]택|국한|분할|포함|[결부조취]합|[미발시수운연진]행|실행|[시실]험|[구실재표]현|[반변]환|[계구기노]획"
KW_NAOTf3 = "경원시|동일시|등한시|송수신|수출입|재실행"
KW_NAOTf = joinseq(KW_NAOTf1, KW_NAOTf2, KW_NAOTf3)
KW_NAOTv1 = "요"
KW_NAOTv2 = "[인추평]가|[공소전]개|[제탈]거|설계|[복연촉]구|[대분상연제표]기|안내|[임증초확]대|[시유주]도|계류|[고]려|신뢰|[완종치]료|[관격분수정처]리|연마|구매|소모|근무|[공거기발]부|준비|[감반발복수조]사|[기축]소|[감준회]수|[감실제출표]시|제어|[기부참]여|[제]외|[소]요|[논유정주회]의|투자|복제|[변참]조|[감유의정중차폐]지|[기탑]재|[교대]체|[갈성수탈편]취|[납배설위]치|검토|돌파|배포|발표|보호|[분이화]해"
