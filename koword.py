...
#### Intransive
KW_NAOIf1 = "벌|찡|참"
KW_NAOIf2 = "일관|[입출]국|합격|집권|[접출]근|기능|도달|탈락|[운]동|[중후]략|[노]력|[관]련|수렴|소멸|연명|[괄]목|함몰|[재폭]발|체벌|중복|손상|발생|연설|소송|통신|작업|[긴등성출퇴]장|경쟁|산적|[도발회]전|근접|방중|[부승약]진|[면유입재]학|방한|[동비서유]행"
KW_NAOIf3 = "불구경|불합격|수소문|하소연"
KW_NAOIf4 = "자리매김"
