...
KW_NAOf = "생각|보간|[가수증]감|동결|곱|[가제]공|[건입출]국|공격|[연체]결|[구변]경|[총포]괄|집권|[접출]근|송금|지급|가늠|기능|[차판]단|[도전]달|[담배해]당|[가기이작]동|[납취획]득|누락|[노]력|[관마수제훈]련|[기수]록|소멸|[발변설소연작제조증]명|[괄주지]목|함몰|질문|고민|위반|[개선]발|체벌|식별|[반중]복|구분|계산|[손연향]상|발생|[분해]석|개선|[건개배연증해]설|[구생작완형]성|[계상접]속|[방소]송|[기저]술|[연학]습|[발송수통]신|송수신|임신|[장파]악|[고보제]안|[계예해]약|선언|[수성영작]업|[구시재]연|오염|[반운촬투]영|[사응이작적통포허활]용|훈육|[기지]원|불응|방일|통일|[기도수투]입|[수]?출입|[동시조]작|[긴등성저출]장|경쟁|산적|[발운회]전|조절|[개걱검결선설수지추측한확]정|방중|검증|감지|부진|[결매모수편]집|[도장부집탈]착|칭찬|제창|[구압]축|[도산수연인제진창추]출|[계예]측|[강이]탈|[간선채]택|[면유입재]학|국한|방한|분할|포함|[결부취]합|[동발비서시수운연진]행|[재]?실행|[구실재표]현|[반변]환|계획"
