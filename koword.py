...
KW_NAOh = "가시화|간소화|강화|경량화|공산화|도커화|디지털화|모듈화|[무유]료화|민주화|[대소]형화|수치화|세분화|시각화|융화|인스턴스화|중앙화|첨예화|초기화|최[신적]화|캡슐화|파편화|패턴화|특[수]?화|현[실행]화|[0-9]+차원화|형상화"
KW_NAOv = "[인증추참평]가|[제탈]거|[공소]개|[경방]과|[연촉]구|[대상연제]기|이야기|시도|[고]려|[완치]료|[관격수]리|[전후]?처리|마무리|연마|소모|근무|[공거기]부|[감반발조퇴]사|[감기축]소|[감준회]수|제시|제어|[기참]여|[긴소중필]요|[논유정합회]의|복제|[유주차폐]지|대체|[성]취|[납배설]치|검토|실패|배포|저하|이해|" + KW_NAOh 
