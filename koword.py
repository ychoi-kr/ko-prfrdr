...
## Thing(무정물)
### Abstract
KW_NTAfc = "관측값|공간|물건|자금|학년|게놈|[능출]력|연령|프로그램|명산|걸음|목적|전략|칼럼|입력|블록|그룹|스트림|별명|[품항]목|논문|[동식]물|동식물|방법|형상|성|창의성|특성|솔루션|커넥션|애플리케이션|[상지]식|직업|앱|영역|비용|차원|웹|도메인|요인|타입|점|규정|[단시장지]점|수준|알고리즘|인터넷|군집|층|토큰|스택|스텝|시스템|패턴|팀|상품|토픽|국민[ ]?평형|모형|힙"
...
KW_NAOv2 = "[인증추참평]가|[제탈]거|[공소전]개|설계|[경방]과|[복연촉]구|[경대상연제표]기|[연증확]대|[시유]도|[고]려|신뢰|[완치]료|[관격분수]리|처리|연마|구매|소모|근무|방미|[공거기]부|준비|[감공반발수식조퇴]사|[감기축]소|[감준회]수|[감실제출표]시|제어|[기참]여|[긴소중필]요|[논유정주합회]의|정의|투자|복제|참조|[유주차폐]지|[기탑]재|대체|[갈성수탈편]취|[납배설위]치|검토|돌파|[부실]패|배포|발표|보호|[저전통]화|[분이]해"
