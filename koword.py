...
KW_NAOf = "생각|보간|[가수증]감|가공|곱|[건입출]국|공격|[연체]결|변경|[총포]괄|집권|[접출]근|송금|가늠|기능|도달|[담배]당|[가이작]동|[납취획]득|누락|[노]력|[관마수제훈]련|[기수]록|[발변설연작제조증]명|괄목|함몰|질문|고민|[개선]발|체벌|[반중]복|준비|[손연향]상|[분해]석|개선|발생|[건개배연증해]설|[구생작완형]성|[계상접]속|[방소]송|[연학]습|임신|[장파]악|[예해]약|[수성영작]업|[구시재]연|오염|[반운촬투]영|[사이작적통포활]용|훈육|[지]원|불응|[도수투]입|[수]?출입|[동시조]작|[긴등성저출]장|산적|[발운회]전|조절|[걱검결설수지추측한]정|검증|부진|선언|[개선수]정|[도장부집탈]착|칭찬|제창|[도산수연인제진창추]출|[계예]측|강탈|[간선채]택|[면유입재]학|국한|분할|포함|[결부취]합|[동비서시수운연진]행|[재]?실행|[구실재표]현|[반변]환|계획"
