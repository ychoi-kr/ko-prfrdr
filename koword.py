...
## Nouns - Status
KW_NSf = "둔감|건강|간결|깔끔|[불]?가능|근면|곤란|[장졸]렬|동일|민감|병약|치열|[단온지]순|참신|[불]?성실|부실|복잡|부족|[부]?적절|공평"
KW_NSv = "유사|[자섬]세|상이|수요|[장중]대|진부|[긴중필]요|부패"
...
KW_Ff = "[A-Za-z0-9]*all|[A-Za-z0-9]*ell|[A-Za-z0-9]*earn|[A-Za-z0-9]*ime|[A-Za-z0-9]*one"  # f: has final consonant in Korean
KW_Fv = "[A-Za-z0-9]*ice|[A-Za-z0-9]*ocks|[A-Za-z0-9]*old|[A-Za-z0-9]*uy|[A-Za-z0-9]*dog|[A-Za-z0-9]*uire"  # v: ends with vowel (does not have final consonant) in Korean
...
KW_NAOh = "[0-9]+차원화|가[상속시]화|간소화|강화|경량화|고도화|공산화|구[간조]화|균일화|대형화|도커화|디지털화|모듈화|미화|무료화|민주화|\\w*변수화|복호화|소형화|수치화|세분화|시각화|암호화|유료화|융화|의무화|인스턴스화|일반화|중앙화|집약화|첨예화|초기화|최[신적]화|캡슐화|파편화|패턴화|특[수]?화|현[실행]화|해시화|형상화|효율화"
KW_NAOv = "[인증추참평]가|[제탈]거|[공소]개|[경방]과|[연촉]구|[경대상연제]기|이야기|[시유]도|[고]려|[완치]료|[관격분수]리|[전후]?처리|마무리|연마|구매|소모|근무|[공거기]부|[감공반발수식조퇴]사|[감기축]소|[감준회]수|[실제출]시|제어|[기참]여|[긴소중필]요|[논유정주합회]의|[재]?정의|복제|[유주차폐]지|대체|[성]취|[납배설]치|검토|돌파|실패|배포|발표|[저전통]화|[분이]해|" + KW_NAOh 
