...
KW_NAOf = "생각|[가수증]감|가공|곱|[건입출]국|공격|[연체]결|변경|[총포]괄|집권|접근|송금|가늠|기능|도달|[담배]당|[가이작]동|[납취획]득|[노]력|[관마수제훈]련|[기수]록|[발변설연작제조증]명|괄목|함몰|질문|고민|[개선]발|체벌|[반중]복|준비|[손연향]상|[분해]석|개선|발생|[건개배연증해]설|[구생작완형]성|[계상]속|[연학]습|임신|[장파]악|[예해]약|[수성영작]업|[구시재]연|오염|[반운촬투]영|[사이작적통포활]용|훈육|[지]원|불응|[승확]인|[도수투]입|[수]?출입|[동시조]작|[긴등성저출]장|[발운회]전|조절|[걱검결설수지추측한]정|검증|부진|선언|[개선수]정|[도장부집탈]착|칭찬|제창|[도수연인제진창추]출|[계예]측|[간선채]택|[면유입재]학|국한|분할|포함|[결부취]합|[전통]화|반환|[구실재표]현|[동비서시수운연진]행|[재]?실행"
...
KW_NAOv = "[인증추참평]가|[제탈]거|[공소]개|[경방]과|[연촉]구|[대상연제]기|이야기|시도|[고]려|[완치]료|[관격수]리|[전후]?처리|마무리|연마|소모|근무|[공거기]부|[감공반발수식조퇴]사|[감기축]소|[감준회]수|제시|제어|[기참]여|[긴소중필]요|[논유정합회]의|복제|[유주차폐]지|대체|[성]취|[납배설]치|검토|실패|배포|저하|[분이]해|" + KW_NAOh 
KW_NAO = joinseq(KW_NAOf, KW_NAOv)

## can be Both of active(-하다) and passive(-받다)
KW_NABf = "비난|감동|처단|할당|[입출]력|주목|처방|[처]?벌|축복|상속|전송|제안|교육|환영|구원|위임|대입|연장|판정|강종|칭찬|추천|부탁|선택|심판|반환|시험"
