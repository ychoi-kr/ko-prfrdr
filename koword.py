...
KW_NAOf = "생각|[가수증]감|가공|곱|[건입출]국|공격|[연체]결|[총포]괄|집권|접근|가늠|[담배]당|[가이]동|[노]력|[관수제훈]련|[기수]록|[발변설연작제조증]명|괄목|함몰|질문|고민|[개선]발|체벌|[반중]복|준비|[수조]사|[손연향]상|개선|발생|[건개배연증해]설|[구생작완형]성|[계상]속|[연학]습|임신|[장파]악|[예해]약|[수성영작]업|[구시재]연|오염|[반운촬투]영|[사이적통포활]용|훈육|[지]원|불응|확인|[도수투]입|[수]?출입|시작|[긴등성저출]장|[발운회]전|조절|[결설수지측한]정|검증|부진|선언|[개선수]정|[도장부집탈]착|칭찬|제창|[도수연인진창추]출|[계예]측|[간선채]택|[면유입재]학|국한|분할|포함|[결부취]합|[미전통]화|[구실재표]현|[비서진]행|[재]?실행|[동수연진]행"
...
KW_NABf = "비난|감동|처단|할당|[입출]력|주목|처방|[처]?벌|축복|전송|교육|구원|위임|대입|연장|강종|추천|부탁|심판|반환|시험"
