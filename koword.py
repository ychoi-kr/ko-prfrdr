...
## Thing(무정물)
### Abstract
KW_NTAfc = "관측값|[공구]간|물건|학년|[능출]력|연령|프로그램|명산|걸음|전략|칼럼|입력|블록|그룹|[품항]목|논문|방법|성|특성|솔루션|애플리케이션|현실|직업|앱|차원|도메인|요인|타입|점|규정|[시지]점|수준|알고리즘|군집|층|토큰|스텝|시스템|패턴|팀|상품|토픽|모형"
