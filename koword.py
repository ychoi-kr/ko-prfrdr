...
## Thing(무정물)
### Abstract
KW_NTAfc = "관측값|공간|물건|학년|[능출]력|연령|프로그램|명산|걸음|목적|전략|칼럼|입력|블록|그룹|스트림|[품항]목|논문|방법|형상|성|창의성|특성|솔루션|커넥션|애플리케이션|[상지]식|직업|앱|영역|차원|도메인|요인|타입|점|규정|[시지]점|수준|알고리즘|군집|층|토큰|스텝|시스템|패턴|팀|상품|토픽|국민[ ]?평형|모형"
...
KW_NAOv = "[인증추참평]가|[제탈]거|[공소전]개|[경방]과|[복연촉]구|[경대상연제표]기|이야기|[시유]도|[고]려|신뢰|[완치]료|[관격분수]리|[전후]?처리|마무리|연마|구매|소모|근무|방미|[공거기]부|준비|[감공반발수식조퇴]사|[감기축]소|[감준회]수|[실제출표]시|제어|[기참]여|[긴소중필]요|[논유정주합회]의|[재]?정의|복제|참조|[유주차폐]지|[기탑]재|대체|[갈성수탈편]취|[납배설]치|검토|돌파|[부실]패|배포|발표|[저전통]화|[분이]해|" + KW_NAOh 
