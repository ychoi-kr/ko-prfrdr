...
KS_Ag = '비슷|착'                       # +해지다       +하다    +할     +한     +해서        +하게   +하지
KS_Ah = '깔끔|매끈|부지런|지저분'       # +해지다       +하다    +할     +한     +해서        +하게   +하지   +히
...
KS_VTk = '모' # does not know       # +르+다     +른+다     +ㄹ+랐다
...
### Active
#                                                                         # no-tense      present        past           past(short)               
KS_VAd = "넣|빼|재"                                                       # 넣+다         넣+는다        넣+었다        x
KS_VAr = "내미|마|[받쳐]?드|허무"                                         # 내미+ㄹ+다    내미+ㄴ+다     내미+ㄹ+었다   x
KS_VAh = "가까이"                                                         # 가까이+하+다  가까이+한+다   가까이+했+다   x
KS_VAi = "내ㅊ|당ㄱ|[되]?[돌살]ㄹ|망ㅊ|숨ㄱ|외ㅊ|[드]높|되뇌|죽|[보]살ㅍ" # 외ㅊ+ㅣ다     외ㅊ+ㅣ+ㄴ+다  외ㅊ+ㅕ+ㅆ+다  x
KS_VAl = "[되][돌살]|[쳐]올|[내때]"                                       # 돌+리다       돌+린다        돌+렸다        x
KS_VAu = "ㅊ|낮ㅊ|늦ㅊ"                                                   # 늦ㅊ+ㅜ+다    늦ㅊ+ㅜ+ㄴ+다  늦ㅊ+ㅜ+었+다  늦ㅊ+ㅝ+ㅆ+다                 
KS_VAw = "[치채키]"                                                       # 치+우다       치+운다        치+웠다        x
