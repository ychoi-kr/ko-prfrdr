...
KS_Aa = '나ㅃ|바ㅃ'                     # +ㅏ지다     +ㅡ+다   +ㅡ+ㄴ  +ㅏ서     +ㅡ+게  +ㅡ+지 
KS_Ab = '귀여|더|무서|쉬|차가|추|해로'  # +워지다     +ㅂ+다   +운     +워서     +ㅂ+게  +ㅂ+지 
KS_Ac = '맑'                            # +아지다     +다      +은     +아서     +게     +지    
KS_Ad = '다'            # sweet         # +ㄹ+아지다  +ㄹ+다   +ㄴ     +ㄹ+아서  +ㄹ+게  +ㄹ+지 
KS_Ae = '예ㅃ'                          # +ㅓ지다     +ㅡ+다   +ㅡ+ㄴ  +ㅓ서     +ㅡ+게  +ㅡ+지 
KS_Af = '다'            # different     # +ㄹ+라지다  +르+다   +른     +ㄹ+라서  +르+게  +르+지 
KS_Ah = '깔끔|긴요|매끈|복잡|비슷|섬세|장대|장렬|졸렬|중요|지저분|진부|착|참신'
                                        # +해지다     +하다    +한     +해서     +하게   +하지
KS_Ai = '붉'                            # +어지다     +다      +은     +어서     +게     +지    
KS_Aj = '같|괜찮|낮|높|좋'              # +아지다     +다      +은     +아서     +게     +지    
KS_Al = '섣부'                          # x           +르다    +른     +ㄹ+러서  +르게   +르지  
KS_Am = '맛있'                          # +어지다     +다      +는     +어서     +게     +지    
KS_An = '낯서|머'                       # +ㄹ+어지다  +ㄹ+다   +ㄴ     +ㄹ+어서  +ㄹ+게  +ㄹ+지 
KS_Ao = '넓'                            # +어지다     +다      +은     +어서     +게     +지    
KS_Ap = '희'                            # +어지다     +다      +ㄴ     +어서     +게     +지    
KS_Ar = '이로|평화로'                   # +와지다     +ㅂ+다   +운     +와서     +ㅂ+게  +ㅂ+지 
KS_As = '나'                            # +아지다     +ㅅ+다   +은     +아서     +ㅅ+게  +ㅅ+지 
KS_Aw = '고'                            # +와지다     +ㅂ+다   +운     +와서     +ㅂ+게  +ㅂ+지 

# '쓰다(bitter)' is not included because it is ambiguous with '쓰다(write)'

KS_Ax = 'ㅋ'                            # +ㅓ+지다,   +ㅡ+다,  +ㅓ+서,  +ㅡ+게,  +ㅡ+지,  +ㅡ+ㄴ
KS_Ay = '못ㄷ'                          # +ㅙ+지다,   +ㅚ+다,  +ㅙ+서,  +ㅚ+게,  +ㅚ+지,  +ㅚㄴ
